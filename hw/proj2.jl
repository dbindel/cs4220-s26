...
# ╔═╡ f6c66ed7-0489-44d9-92e9-fa3044dca99a
using Images

# ╔═╡ c5a3cf78-2d27-45b2-83b2-aad447c324f7
using FileIO

# ╔═╡ cc529a43-efeb-473b-b053-c0acad15a34b
using FFTW

# ╔═╡ f7dc8f80-85a7-49b4-992b-bb33a026d38a
using Colors

# ╔═╡ 916fc820-8f8b-431b-bec4-efb7159ec27e
using Roots

# ╔═╡ bf26a8c0-13c5-4ede-81d4-dffa91583300
using Plots

# ╔═╡ ed655367-9fc1-4b06-bd21-e68100655d02
using DelimitedFiles

# ╔═╡ c8b0ca59-89ad-40fa-9e42-219a6b2b8272
using LinearAlgebra

# ╔═╡ f25e6de4-a05f-11ec-24f8-c1227f90b287
md"""
...
# ╔═╡ f2ac4bd9-67ce-4d0d-8964-cda079e8f9c5
md"""
## Julia setup
...
# ╔═╡ 139086f8-047a-4255-963a-062b799d4881
md"""
...
# ╔═╡ b8483837-5348-4453-b2ad-ff47ef637fa5
typeof(blurry_img)

# ╔═╡ 307e66f0-b907-4ef5-9c45-347f21f34919
md"""
...
# ╔═╡ ae75d845-44ae-4f8d-98a3-3e98668792bd
# Convenience function to count pixels
img_rgb_pixels(V) = prod(size(V)[2:3])

# ╔═╡ 7f43753e-9e0c-48ef-b184-6f44ea3a8e9a
...
# ╔═╡ 3fe7a34b-6755-4be3-b68a-6762be81a2a5
arrays_to_img(blurry_rgb)

# ╔═╡ 3e5e0eb3-9c33-4c15-b6b4-9df570e96481
md"""npixels = $(img_rgb_pixels(blurry_rgb))"""

# ╔═╡ fbc3ce80-8a40-489d-b725-e3025503c71b
md"""
...
# ╔═╡ 37143e21-1b8c-4ec3-99e9-482007acde7a
...
0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 7.7554345826199725f-03 1.9137518038719433f-02 3.0519601494818908f-02 2.4656286433015855f-02 1.3274202976916394f-02 1.8921195208169185f-03 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 ;
0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 4.8812014963028841f-03 1.6263284952402354f-02 2.7645368408501823f-02 2.7530519519332945f-02 1.6148436063233483f-02 4.7663526071340069f-03 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 ;
0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 2.0069684099857958f-03 1.3389051866085265f-02 2.4771135322184737f-02 3.0404752605650034f-02 1.9022669149550565f-02 7.6405856934510952f-03 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 ;
0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 1.0514818779768179f-02 2.1896902235867651f-02 3.3278985691967120f-02 2.1896902235867651f-02 1.0514818779768179f-02 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 ;
0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 7.6405856934510952f-03 1.9022669149550565f-02 3.0404752605650034f-02 2.4771135322184737f-02 1.3389051866085265f-02 2.0069684099857958f-03 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 ;
0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 4.7663526071340069f-03 1.6148436063233483f-02 2.7530519519332945f-02 2.7645368408501823f-02 1.6263284952402354f-02 4.8812014963028841f-03 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 ;
0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 1.8921195208169185f-03 1.3274202976916394f-02 2.4656286433015855f-02 3.0519601494818908f-02 1.9137518038719433f-02 7.7554345826199725f-03 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 ;
0.0000000000000000f+00 1.0399969890599306f-02 2.1782053346698766f-02 3.3164136802798241f-02 2.2011751125036522f-02 1.0629667668937061f-02 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 ;
2.0744015897822540f-02 2.4885984211353594f-02 1.3503900755254135f-02 2.1218172991546583f-03 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 0.0000000000000000f+00 ]

# ╔═╡ 71cbfb10-187b-45d2-95cb-9641da41a164
Gray.(K/maximum(K))

# ╔═╡ 2fc0f6d8-809f-4b86-b1d7-bbcd60dd0c70
md"""
...
# ╔═╡ 506280bf-8d16-4e6d-8207-01929ae18f04
...
# ╔═╡ 7715b39d-a4d0-49d0-b3b3-97add00c0e5a
s = get_psf_fft(blurry_img, K)

# ╔═╡ fe93a125-abfe-4573-8289-91a9e6c9037f
Gray.(abs.(s))

# ╔═╡ 86b38c58-aecc-4374-8d2b-ef5a99c10144
md"""
...
# ╔═╡ def8b9b9-c58a-467f-8ca8-e3fcc0cb1217
begin
	...
	dot_fft(Vt1, Vt2) = dot(Vt1[:], Vt2[:])
	normF_fft(Vt) = sqrt(real(dot_fft(Vt, Vt)))
	resid_norm_fft(Vt, s, λ) = normF_fft(blur_fft(Vt, resid_factors(s, λ)))
	
	# Apply the (regularized) deblurring operator and convert to a standard image
	deblur_img(V, s, λ) = arrays_to_img(deblur(V, s, λ))
	
	# Compute the residual norm
	resid_norm(V, s, λ) = resid_norm_fft(img_fft(V), s, λ)
end

# ╔═╡ ce32db21-0ddf-4690-aa98-d2827a4476d7
md"""
...
# ╔═╡ e70e4401-8081-4a96-81c6-f9bcccdc8e35
md"""
#### Solutions
"""

# ╔═╡ 3a9f7e7b-f4b2-4971-bf74-259299e9ddfe
md"""
...
# ╔═╡ c06535b1-271a-4da3-975c-7c636eee5088
md"""
...
# ╔═╡ 1490df5f-6d1d-4b59-bcc5-ed3bc2cf1aa2
md"""
#### Solutions
...
# ╔═╡ a14a5332-693f-41af-9b7c-7b57d4389536
begin
...
# ╔═╡ a19b3e1d-6de2-410c-a92d-19d166f369ad
md"""
...
# ╔═╡ 84d69838-b225-4534-ac8c-b167aef034bc
md"""
#### Solutions
...
# ╔═╡ 3ee87c54-f6c9-4433-9444-5a7a8318625b
md"""
...
# ╔═╡ 84042028-d5fc-4473-ac60-987c13a12778
begin
...
# ╔═╡ 5b982dcd-a524-4b72-b098-802ff0e48ab7
md"""
### The L-curve
...
# ╔═╡ 26bb0a35-745d-4247-a0da-5f509c576d15
function lcurvet(V, s, λ)
    ...
    return sqrt(ρ2), sqrt(η2), κ
end

# ╔═╡ 00bc6379-7891-482a-923c-0a5982e1a25d
lcurve(V, s, λ) = lcurvet(img_fft(V), s, λ)

# ╔═╡ 70183f1e-351f-4c5e-baba-d4e09836c5f7
md"""
#### Solutions
...
# ╔═╡ 3ea85b7f-33fa-4221-8178-eaadefa4741e
...
# ╔═╡ 6280028a-fa84-478a-af70-13953698f32b
...
# ╔═╡ 68bfd826-9459-481c-9030-780304c3cbcd
p1lc, p2lc, λ_lcurve = plot_lcurve(blurry_rgbt, s, τ)

# ╔═╡ 1a0f3adf-2678-4636-8497-afbd57ac3aaf
p1lc

# ╔═╡ a9253ff2-9a39-4f8f-9442-24fef394e1fc
p2lc

# ╔═╡ 9a970ddb-430e-4bed-a01c-615e72d56c10
λ_lcurve

# ╔═╡ a47c2021-8bec-464e-91d1-8e1a13a35def
deblur_img(blurry_rgb, s, λ_lcurve)

# ╔═╡ 8748c4b4-0ade-4634-b39f-f52322eb51cc
md"""
## Notes
...
manifest_format = "2.0"
project_hash = "0de3ec2e5b78689388d61ac7e6f0beba0e3d83f0"
